...
public class UtilsBH1 {
    ...
    public static double readDouble(String prompt, boolean flagGUI)   {
        ...
        // if the flag statement is true
            ...
            while (failed == true)  {
                try {
                    ...
                    // intercepts failed attempt to convert a double
                }
            }
        }
        return data;
    ...
    public static String readString(String prompt, boolean flagGUI)   {
        Scanner input;
        String data;
        
        // if flag GUI flase, user input from command line
        if (flagGUI == false)   {
            input = new Scanner(System.in);
            System.out.print(prompt);
            data = input.nextLine();
        }
        // else, user input from GUI menu
        else    {
    ...
    public static int randomInt(int min, int max)   {
        int randNum;
        // assign random object type
        Random rand = new Random();
        
        // assign random int with given values
